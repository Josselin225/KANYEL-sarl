...
import { getArticles, getDepartments, getSettings, pick, type Locale } from "@/lib/api";
    ...
    <>
      ...
      <main>
        <section className="relative flex h-[45vh] min-h-[340px] w-full items-end overflow-hidden bg-navy-deep">
          {article.cover_image && (
            <Image src={article.cover_image} alt={pick(article, "title", locale as Locale)} fill priority sizes="100vw" className="object-cover" />
          )}
          ...
          <div className="relative mx-auto w-full max-w-3xl px-5 pb-14 sm:px-8">
            ...
            <h1 className="mt-2 font-display text-3xl font-semibold text-white sm:text-4xl">
              {pick(article, "title", locale as Locale)}
            </h1>
          </div>
        </section>
